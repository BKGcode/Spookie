...
public class MUS_CharController : MonoBehaviour
{
    [Header("References")]
    ...
    MUS_PlayerInputHandler m_InputHandler;
    ...
    void Start()
    {
        ...
        m_InputHandler = GetComponent<MUS_PlayerInputHandler>();
    ...
    void HandleCharacterMovement()
    {
        ...
        bool isLooking = m_InputHandler.GetAimInputHeld();
        {
